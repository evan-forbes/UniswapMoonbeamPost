...
//     );
//     event Sync(uint112 reserve0, uint112 reserve1);
//     event MiddlewareSet(address middleware);
...
//     // called once by the factory at time of deployment
//     function initialize(address _token0, address _token1, address mid) external {
//         require(msg.sender == factory, 'UniswapV2: FORBIDDEN'); // sufficient check
//         token0 = _token0;
//         token1 = _token1;
//         middleware = mid;
...
//     function setMiddleware(address mid) external {
//         require(msg.sender == IUniswapV2Factory(factory).feeToSetter());
//         middleware = mid;
//         emit MiddlewareSet(mid);
//     }
